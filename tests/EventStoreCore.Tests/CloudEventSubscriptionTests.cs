            ...
            c.AddCloudEventSubscription<TestSub>(c =>
            {
                c.MapEvent<TestEvent>(ievent =>
                {
                    var cloudEvent = new CloudEvent(
                        ...
                        type: "com.EventStoreCore.tests.subscriptions.testevent",
                ...
                c.MapEvent<TestEvent2>("com.EventStoreCore.tests.subscriptions.testevent2", "urn:tests.subscriptions", ievent => $"tests/subscriptions2/{ievent.Data.Id}");
            });
        });
